/**
 * 章节: React 表单与事件
 * 来源: 22-forms-events/example_1.jsx（形状A | class）
...
export const title = "React 表单与事件 · example_1";
export const sourceFile = "22-forms-events/example_1.jsx";
export const shape = "A";
export const rawCode = "class HelloMessage extends React.Component {\n  constructor(props) {\n      super(props);\n      this.state = {value: 'Hello Runoob!'};\n      this.handleChange = this.handleChange.bind(this);\n  }\n \n  handleChange(event) {\n    this.setState({value: event.target.value});\n  }\n  render() {\n    var value = this.state.value;\n    return <div>\n            <input type=\"text\" value={value} onChange={this.handleChange} /> \n            <h4>{value}</h4>\n           </div>;\n  }\n}\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n  <HelloMessage />\n);";
