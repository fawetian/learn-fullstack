/**
 * 章节: React 表单与事件
 * 来源: 22-forms-events/example_4.jsx（形状C | class）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「Reservation」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Reservation));
...
export const title = "React 表单与事件 · example_4";
export const sourceFile = "22-forms-events/example_4.jsx";
export const shape = "C";
export const rawCode = "class Reservation extends React.Component {\n  constructor(props) {\n    super(props);\n    this.state = {\n      isGoing: true,\n      numberOfGuests: 2\n    };\n \n    this.handleInputChange = this.handleInputChange.bind(this);\n  }\n \n  handleInputChange(event) {\n    const target = event.target;\n    const value = target.type === 'checkbox' ? target.checked : target.value;\n    const name = target.name;\n \n    this.setState({\n      [name]: value\n    });\n  }\n \n  render() {\n    return (\n      <form>\n        <label>\n          是否离开:\n          <input\n            name=\"isGoing\"\n            type=\"checkbox\"\n            checked={this.state.isGoing}\n            onChange={this.handleInputChange} />\n        </label>\n        <br />\n        <label>\n          访客数:\n          <input\n            name=\"numberOfGuests\"\n            type=\"number\"\n            value={this.state.numberOfGuests}\n            onChange={this.handleInputChange} />\n        </label>\n      </form>\n    );\n  }\n}";
