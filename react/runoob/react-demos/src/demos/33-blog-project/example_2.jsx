/**
 * 章节: React 博客项目：初始化
 * 来源: 33-blog-project/example_2.jsx（形状C | 函数）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「Greeting」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Greeting));
...
export const title = "React 博客项目：初始化 · example_2";
export const sourceFile = "33-blog-project/example_2.jsx";
export const shape = "C";
export const rawCode = "// JSX 就是 return 后面的这段类 HTML 代码\n\nfunction Greeting() {\n\n  const name = 'RUNOOB'\n\n  const isLoggedIn = true\n\n  return (\n\n    <div className=\"greeting\">\n\n      {/* JSX 注释：花括号内放任何 JS 表达式 */}\n\n      <h1>Hello, {name}!</h1>\n\n      <p>当前时间：{new Date().toLocaleDateString()}</p>\n\n      {isLoggedIn && <p>欢迎回来！</p>}\n\n    </div>\n\n  )\n\n}";
