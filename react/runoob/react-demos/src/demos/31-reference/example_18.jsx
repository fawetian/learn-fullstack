/**
 * 章节: React 参考手册
 * 来源: 31-reference/example_18.jsx（形状A | 函数）
...
export const title = "React 参考手册 · example_18";
export const sourceFile = "31-reference/example_18.jsx";
export const shape = "A";
export const rawCode = "const element = <h1>Hello, World!</h1>;\n\nReactDOM.render(element, document.getElementById('root'));";
