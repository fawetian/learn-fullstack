/**
 * 章节: React 参考手册
 * 来源: 31-reference/example_13.jsx（形状C | hooks）
...
export const title = "React 参考手册 · example_13";
export const sourceFile = "31-reference/example_13.jsx";
export const shape = "C";
export const rawCode = "const MyContext = React.createContext('default');\n\nfunction MyComponent() {\n\n  const contextValue = useContext(MyContext);\n\n  return <p>Context value: {contextValue}</p>;\n\n}";
