/**
 * 章节: React 参考手册
 * 来源: 31-reference/example_8.jsx（形状C | class）
...
export const title = "React 参考手册 · example_8";
export const sourceFile = "31-reference/example_8.jsx";
export const shape = "C";
export const rawCode = "class MyComponent extends Component {\n\n  componentDidUpdate(prevProps, prevState) {\n\n    // 当 props 或 state 变化时更新数据\n\n    if (this.props.userID !== prevProps.userID) {\n\n      this.fetchData(this.props.userID);\n\n    }\n\n  }\n\n  render() {\n\n    return <div>{this.props.userID}</div>;\n\n  }\n\n}";
