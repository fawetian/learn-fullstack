/**
 * 章节: React 参考手册
 * 来源: 31-reference/example_11.jsx（形状C | hooks）
...
export const title = "React 参考手册 · example_11";
export const sourceFile = "31-reference/example_11.jsx";
export const shape = "C";
export const rawCode = "function Counter() {\n\n  const [count, setCount] = useState(0);\n\n  return (\n\n    <div>\n\n      <p>You clicked {count} times</p>\n\n      <button onClick={() => setCount(count + 1)}>Click me</button>\n\n    </div>\n\n  );\n\n}";
