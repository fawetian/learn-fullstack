/**
 * 章节: React 参考手册
 * 来源: 31-reference/example_17.jsx（形状C | hooks）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「TextInputWithFocusButton」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(TextInputWithFocusButton));
...
export const title = "React 参考手册 · example_17";
export const sourceFile = "31-reference/example_17.jsx";
export const shape = "C";
export const rawCode = "function TextInputWithFocusButton() {\n\n  const inputRef = useRef(null);\n\n  useEffect(() => {\n\n    inputRef.current.focus();\n\n  }, []);\n\n  return (\n\n    <>\n\n      <input ref={inputRef} type=\"text\" />\n\n      <button onClick={() => inputRef.current.focus()}>Focus Input</button>\n\n    </>\n\n  );\n\n}";
