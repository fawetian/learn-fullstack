/**
 * 章节: 博客·useEffect
 * 来源: 38-blog-useeffect/example_2.jsx —— ⚠️ 纯 JSON 数据文件，非 React 代码
 */
export const title = "博客·useEffect · example_2 (源码展示)";
export const sourceFile = "38-blog-useeffect/example_2.jsx";
