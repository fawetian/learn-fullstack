/**
 * 章节: 博客·路由
 * 来源: 37-blog-router/example_1.jsx —— ⚠️ 导出的是路由配置对象（createBrowserRouter），非组件
 */
export const title = "博客·路由 · example_1 (源码展示)";
export const sourceFile = "37-blog-router/example_1.jsx";
