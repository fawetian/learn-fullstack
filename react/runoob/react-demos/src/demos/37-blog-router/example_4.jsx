/**
 * 章节: React 博客项目：路由
 * 来源: 37-blog-router/example_4.jsx（形状C | 函数）
...
export const title = "React 博客项目：路由 · example_4";
export const sourceFile = "37-blog-router/example_4.jsx";
export const shape = "C";
export const rawCode = "function BlogCard({ id, title, summary, date, category }) {\n\n  return (\n\n    <Link to={`/post/${id}`} className=\"card-link\">\n\n      <div className=\"card\">\n\n        <span className=\"tag\">{category}</span>\n\n        <h3>{title}</h3>\n\n        <p>{summary}</p>\n\n        <span className=\"date\">{date}</span>\n\n      </div>\n\n    </Link>\n\n  )\n\n}";
