/**
 * 章节: 博客·路由
 * 来源: 37-blog-router/example_8.jsx —— ⚠️ 依赖外部文件（../components/BlogCard, ../components/CategoryFilter），属多文件项目片段，无法独立运行
 */
export const title = "博客·路由 · example_8 (源码展示)";
export const sourceFile = "37-blog-router/example_8.jsx";
