/**
 * 章节: React 列表与 Keys
 * 来源: 18-lists-keys/example_1.jsx（形状A | 函数）
...
export const title = "React 列表与 Keys · example_1";
export const sourceFile = "18-lists-keys/example_1.jsx";
export const shape = "A";
export const rawCode = "const numbers = [1, 2, 3, 4, 5];\nconst listItems = numbers.map((numbers) =>\n  <li>{numbers}</li>\n);\n \nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n  <ul>{listItems}</ul>\n);";
