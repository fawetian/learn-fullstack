/**
 * 章节: React 列表与 Keys
 * 来源: 18-lists-keys/example_2.jsx（形状A | 函数）
...
export const title = "React 列表与 Keys · example_2";
export const sourceFile = "18-lists-keys/example_2.jsx";
export const shape = "A";
export const rawCode = "function NumberList(props) {\n  const numbers = props.numbers;\n  const listItems = numbers.map((number) =>\n    <li key={number.toString()}>\n      {number}\n    </li>\n  );\n  return (\n    <ul>{listItems}</ul>\n  );\n}\n \nconst numbers = [1, 2, 3, 4, 5];\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n  <NumberList numbers={numbers} />\n);";
