/**
 * 章节: React 事件处理
 * 来源: 16-event-handle/example_2.jsx（形状A | class）
...
export const title = "React 事件处理 · example_2";
export const sourceFile = "16-event-handle/example_2.jsx";
export const shape = "A";
export const rawCode = "class Toggle extends React.Component {\n  constructor(props) {\n    super(props);\n    this.state = {isToggleOn: true};\n \n    // 这边绑定是必要的，这样 `this` 才能在回调函数中使用\n    this.handleClick = this.handleClick.bind(this);\n  }\n \n  handleClick() {\n    this.setState(prevState => ({\n      isToggleOn: !prevState.isToggleOn\n    }));\n  }\n \n  render() {\n    return (\n      <button onClick={this.handleClick}>\n        {this.state.isToggleOn ? 'ON' : 'OFF'}\n      </button>\n    );\n  }\n}\n \nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n  <Toggle />,\n  document.getElementById('example')\n);";
