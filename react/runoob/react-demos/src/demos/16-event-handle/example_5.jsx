/**
 * 章节: React 事件处理
 * 来源: 16-event-handle/example_5.jsx（形状C | class）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「Popper」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Popper));
...
export const title = "React 事件处理 · example_5";
export const sourceFile = "16-event-handle/example_5.jsx";
export const shape = "C";
export const rawCode = "class Popper extends React.Component{\n    constructor(){\n        super();\n        this.state = {name:'Hello world!'};\n    }\n    \n    preventPop(name, e){    //事件对象e要放在最后\n        e.preventDefault();\n        alert(name);\n    }\n    \n    render(){\n        return (\n            <div>\n                <p>hello</p>\n                {/* 通过 bind() 方法传递参数。 */}\n                <a href=\"https://reactjs.org\" onClick={this.preventPop.bind(this,this.state.name)}>Click</a>\n            </div>\n        );\n    }\n}";
