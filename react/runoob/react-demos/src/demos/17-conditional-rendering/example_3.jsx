/**
 * 章节: React 条件渲染
 * 来源: 17-conditional-rendering/example_3.jsx（形状A | 函数）
...
export const title = "React 条件渲染 · example_3";
export const sourceFile = "17-conditional-rendering/example_3.jsx";
export const shape = "A";
export const rawCode = "function Mailbox(props) {\n  const unreadMessages = props.unreadMessages;\n  return (\n    <div>\n      <h1>Hello!</h1>\n      {unreadMessages.length > 0 &&\n        <h2>\n          您有 {unreadMessages.length} 条未读信息。\n        </h2>\n      }\n    </div>\n  );\n}\n \nconst messages = ['React', 'Re: React', 'Re:Re: React'];\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n  <Mailbox unreadMessages={messages} />\n);";
