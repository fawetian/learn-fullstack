/**
 * 章节: React Memo
 * 来源: 26-memo/example_1.jsx（形状A | hooks）
...
export const title = "React Memo · example_1";
export const sourceFile = "26-memo/example_1.jsx";
export const shape = "A";
export const rawCode = "const MyComponent = React.memo((props) => {\n\n  console.log('Rendering MyComponent');\n\n  return <div>{props.text}</div>;\n\n});\n\nconst App = () => {\n\n  const [count, setCount] = React.useState(0);\n\n  const [text, setText] = React.useState('Hello, world!');\n\n  return (\n\n    <div>\n\n      <button onClick={() => setCount(count + 1)}>Increment Count</button>\n\n      <MyComponent text={text} />\n\n    </div>\n\n  );\n\n};\n\nconst root = ReactDOM.createRoot(document.getElementById('root'));\n\nroot.render(<App />);";
