/**
 * 章节: React Memo
 * 来源: 26-memo/example_3.jsx（形状A | hooks）
...
export const title = "React Memo · example_3";
export const sourceFile = "26-memo/example_3.jsx";
export const shape = "A";
export const rawCode = "const ChildComponent = React.memo(({ onClick, count }) => {\n\n  console.log('Rendering ChildComponent');\n\n  return <button onClick={onClick}>Count: {count}</button>;\n\n});\n\nconst App = () => {\n\n  const [count, setCount] = useState(0);\n\n  const increment = useCallback(() => {\n\n    setCount(count + 1);\n\n  }, [count]);\n\n  const doubledCount = useMemo(() => count * 2, [count]);\n\n  return (\n\n    <div>\n\n      <p>Doubled Count: {doubledCount}</p>\n\n      <ChildComponent onClick={increment} count={count} />\n\n    </div>\n\n  );\n\n};\n\nconst root = ReactDOM.createRoot(document.getElementById('root'));\n\nroot.render(<App />);";
