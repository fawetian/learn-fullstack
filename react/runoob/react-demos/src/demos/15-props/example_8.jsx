/**
 * 章节: React Props（属性）
 * 来源: 15-props/example_8.jsx（形状A | class）
...
export const title = "React Props（属性） · example_8";
export const sourceFile = "15-props/example_8.jsx";
export const shape = "A";
export const rawCode = "var title = \"菜鸟教程\";\n// var title = 123;\nclass MyTitle extends React.Component {\n  render() {\n    return (\n      <h1>Hello, {this.props.title}</h1>\n    );\n  }\n}\n \nMyTitle.propTypes = {\n  title: PropTypes.string\n};\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n    <MyTitle title={title} />\n);";
