/**
 * 章节: React Props（属性）
 * 来源: 15-props/example_4.jsx（形状A | 函数）
...
export const title = "React Props（属性） · example_4";
export const sourceFile = "15-props/example_4.jsx";
export const shape = "A";
export const rawCode = "const Greeting = (props) => {\n\n  return <h1>Hello, {props.name}!</h1>;\n\n};\n\nGreeting.propTypes = {\n\n  name: PropTypes.string.isRequired\n\n};\n\nconst App = () => {\n\n  return (\n\n    <div>\n\n      <Greeting name=\"Alice\" />\n\n      {/* <Greeting />  // 这行代码会导致控制台警告，因为 name 是必需的 */}\n\n    </div>\n\n  );\n\n};\n\nReactDOM.render(<App />, document.getElementById('root'));";
