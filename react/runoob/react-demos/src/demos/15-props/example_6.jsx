/**
 * 章节: React Props（属性）
 * 来源: 15-props/example_6.jsx（形状A | 函数）
...
export const title = "React Props（属性） · example_6";
export const sourceFile = "15-props/example_6.jsx";
export const shape = "A";
export const rawCode = "const Greeting = ({ name }) => {\n\n  return <h1>Hello, {name}!</h1>;\n\n};\n\nconst App = () => {\n\n  return <Greeting name=\"Alice\" />;\n\n};\n\nReactDOM.render(<App />, document.getElementById('root'));";
