/**
 * 章节: React Props（属性）
 * 来源: 15-props/example_5.jsx（形状A | class）
...
export const title = "React Props（属性） · example_5";
export const sourceFile = "15-props/example_5.jsx";
export const shape = "A";
export const rawCode = "class ParentComponent extends React.Component {\n\n  constructor(props) {\n\n    super(props);\n\n    this.state = { message: '' };\n\n  }\n\n  handleMessage = (msg) => {\n\n    this.setState({ message: msg });\n\n  };\n\n  render() {\n\n    return (\n\n      <div>\n\n        <ChildComponent onMessage={this.handleMessage} />\n\n        <p>Message from Child: {this.state.message}</p>\n\n      </div>\n\n    );\n\n  }\n\n}\n\nconst ChildComponent = (props) => {\n\n  const sendMessage = () => {\n\n    props.onMessage('Hello from Child!');\n\n  };\n\n  return (\n\n    <div>\n\n      <button onClick={sendMessage}>Send Message</button>\n\n    </div>\n\n  );\n\n};\n\nReactDOM.render(<ParentComponent />, document.getElementById('root'));";
