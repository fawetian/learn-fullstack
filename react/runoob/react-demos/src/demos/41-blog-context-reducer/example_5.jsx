 ...
 * 来源: 41-blog-context-reducer/example_5.jsx —— ⚠️ 依赖外部文件（../context/FavoriteContext），属多文件项目片段，无法独立运行
 */
export const title = "博客·Context/Reducer · example_5 (源码展示)";
export const sourceFile = "41-blog-context-reducer/example_5.jsx";
