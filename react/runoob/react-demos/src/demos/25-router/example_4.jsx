/**
 * 章节: React 路由
 * 来源: 25-router/example_4.jsx（形状B | 函数）
...
export function mount(container) {
  ...
  Profile;
  /* ↑ 原始代码定义了组件，自动挑「Profile」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Profile));
...
export const title = "React 路由 · example_4";
export const sourceFile = "25-router/example_4.jsx";
export const shape = "B";
export const rawCode = "// Profile.js\n\nconst Profile = () => {\n\n  return <h2>Profile</h2>;\n\n};\nProfile;";
