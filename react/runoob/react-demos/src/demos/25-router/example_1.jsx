/**
 * 章节: React 路由
 * 来源: 25-router/example_1.jsx（形状B | 函数）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「Home」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Home));
...
export const title = "React 路由 · example_1";
export const sourceFile = "25-router/example_1.jsx";
export const shape = "B";
export const rawCode = "const Home = () => {\n  return <h2>Home</h2>;\n};\n\nconst About = () => {\n  return <h2>About</h2>;\n};\n\nconst Contact = () => {\n  return <h2>Contact</h2>;\n};";
