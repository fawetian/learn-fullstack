/**
 * 章节: React 路由
 * 来源: 25-router/example_3.jsx（形状B | 函数）
...
export function mount(container) {
  ...
  Dashboard;
  /* ↑ 原始代码定义了组件，自动挑「Dashboard」渲染（外层包 BrowserRouter 提供 router 上下文） ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(BrowserRouter, null, React.createElement(Dashboard)));
...
export const title = "React 路由 · example_3";
export const sourceFile = "25-router/example_3.jsx";
export const shape = "B";
export const rawCode = "// Dashboard.js\n\nconst Dashboard = () => {\n\n  return (\n\n    <div>\n\n      <h2>Dashboard</h2>\n\n      <nav>\n\n        <ul>\n\n          <li>\n\n            <Link to=\"profile\">Profile</Link>\n\n          </li>\n\n          <li>\n\n            <Link to=\"settings\">Settings</Link>\n\n          </li>\n\n        </ul>\n\n      </nav>\n\n      <Outlet />\n\n    </div>\n\n  );\n\n};\nDashboard;";
