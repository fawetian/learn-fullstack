/**
 * 章节: React 路由
 * 来源: 25-router/example_5.jsx（形状B | 函数）
...
export function mount(container) {
  ...
  Settings;
  /* ↑ 原始代码定义了组件，自动挑「Settings」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(Settings));
...
export const title = "React 路由 · example_5";
export const sourceFile = "25-router/example_5.jsx";
export const shape = "B";
export const rawCode = "// Settings.js\n\nconst Settings = () => {\n\n  return <h2>Settings</h2>;\n\n};\nSettings;";
