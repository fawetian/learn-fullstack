/**
 * 章节: React 路由
 * 来源: 25-router/example_7.jsx（形状B | 函数）
...
export function mount(container) {
  ...
  User;
  /* ↑ 原始代码定义了组件，自动挑「User」渲染（外层包 BrowserRouter 提供 router 上下文） ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(BrowserRouter, null, React.createElement(User)));
...
export const title = "React 路由 · example_7";
export const sourceFile = "25-router/example_7.jsx";
export const shape = "B";
export const rawCode = "// User.js\n\nconst User = () => {\n\n  const { userId } = useParams();\n\n  return <h2>User ID: {userId}</h2>;\n\n};\nUser;";
