/**
 * 章节: 博客·Props
 * 来源: 36-blog-props/example_2.jsx —— ⚠️ 依赖外部文件（./components/BlogCard），属多文件项目片段，无法独立运行
 */
export const title = "博客·Props · example_2 (源码展示)";
export const sourceFile = "36-blog-props/example_2.jsx";
