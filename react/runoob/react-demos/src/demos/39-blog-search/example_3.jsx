/**
 * 章节: 博客·搜索
 * 来源: 39-blog-search/example_3.jsx —— ⚠️ 依赖外部文件（../components/BlogCard, ../components/CategoryFilter），属多文件项目片段，无法独立运行
 */
export const title = "博客·搜索 · example_3 (源码展示)";
export const sourceFile = "39-blog-search/example_3.jsx";
