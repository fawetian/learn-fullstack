/**
 * 章节: React 组件
 * 来源: 13-components/example_1.jsx（形状B | 函数）
...
export const title = "React 组件 · example_1";
export const sourceFile = "13-components/example_1.jsx";
export const shape = "B";
export const rawCode = "// 定义一个函数组件\n\nfunction Welcome(props) {\n\n  return <h1>Hello, {props.name}!</h1>;\n\n}\nWelcome;";
