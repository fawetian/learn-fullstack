/**
 * 章节: React 组件
 * 来源: 13-components/example_5.jsx（形状A | 函数）
...
export const title = "React 组件 · example_5";
export const sourceFile = "13-components/example_5.jsx";
export const shape = "A";
export const rawCode = "function HelloMessage(props) {\n    return <h1>Hello World!</h1>;\n}\n \nconst element = <HelloMessage />;\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n    element\n);";
