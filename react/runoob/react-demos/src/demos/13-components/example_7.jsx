/**
 * 章节: React 组件
 * 来源: 13-components/example_7.jsx（形状A | 函数）
...
export const title = "React 组件 · example_7";
export const sourceFile = "13-components/example_7.jsx";
export const shape = "A";
export const rawCode = "function Name(props) {\n    return <h1>网站名称：{props.name}</h1>;\n}\nfunction Url(props) {\n    return <h1>网站地址：{props.url}</h1>;\n}\nfunction Nickname(props) {\n    return <h1>网站小名：{props.nickname}</h1>;\n}\nfunction App() {\n    return (\n    <div>\n        <Name name=\"菜鸟教程\" />\n        <Url url=\"http://www.runoob.com\" />\n        <Nickname nickname=\"Runoob\" />\n    </div>\n    );\n}\n \nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n     <App />\n);";
