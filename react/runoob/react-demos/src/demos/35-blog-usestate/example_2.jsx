 ...
 * 来源: 35-blog-usestate/example_2.jsx（形状C | hooks）
...
export function mount(container) {
  ...
  /* ↑ 原始代码定义了组件，自动挑「ArticleManager」渲染 ↓ */
  try {
    const _r = createRoot(container);
    _roots.push(_r);
    _r.render(React.createElement(ArticleManager));
...
export const title = "React 博客项目：useState · example_2";
export const sourceFile = "35-blog-usestate/example_2.jsx";
export const shape = "C";
export const rawCode = "function ArticleManager() {\n\n  const [title, setTitle] = useState('默认标题')\n\n  // 错误写法：直接修改\n\n  // title = '新标题'  // React 不知道你改了，不会重新渲染\n\n  // 正确写法：通过 setter 更新\n\n  function updateTitle() {\n\n    setTitle('新标题')  // React 知道状态变了，会重新渲染\n\n  }\n\n  return (\n\n    <div>\n\n      <p>{title}</p>\n\n      <button onClick={updateTitle}>修改标题</button>\n\n    </div>\n\n  )\n\n}";
