/**
 * 章节: React JSX
 * 来源: 12-jsx/example_9.jsx（形状A | 函数）
...
export const title = "React JSX · example_9";
export const sourceFile = "12-jsx/example_9.jsx";
export const shape = "A";
export const rawCode = "const root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(\n    <div>\n    <h1>菜鸟教程</h1>\n    {/*注释...*/}\n    </div>\n);";
