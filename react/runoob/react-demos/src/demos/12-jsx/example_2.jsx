/**
 * 章节: React JSX
 * 来源: 12-jsx/example_2.jsx（形状A | 函数）
...
export const title = "React JSX · example_2";
export const sourceFile = "12-jsx/example_2.jsx";
export const shape = "A";
export const rawCode = "const element = <h1 className=\"foo\">Hello, world</h1>;\nconst root = ReactDOM.createRoot(document.getElementById(\"root\"));\nroot.render(element);";
