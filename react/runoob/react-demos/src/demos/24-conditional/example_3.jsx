/**
 * 章节: React 条件语句
 * 来源: 24-conditional/example_3.jsx（形状A | 函数）
...
export const title = "React 条件语句 · example_3";
export const sourceFile = "24-conditional/example_3.jsx";
export const shape = "A";
export const rawCode = "const MyComponent = (props) => {\n\n  const isLoggedIn = props.isLoggedIn;\n\n  return (\n\n    <div>\n\n      {isLoggedIn && <h1>Welcome back!</h1>}\n\n      {!isLoggedIn && <h1>Please sign up.</h1>}\n\n    </div>\n\n  );\n\n};\n\nconst root = ReactDOM.createRoot(document.getElementById('root'));\n\nroot.render(<MyComponent isLoggedIn={true} />);";
