// ============================================================
// 【第 43 节 · JavaScript String】demo5.js
// ============================================================
//
// 【知识点 / 后端类比】
...
//
var txt="Hello World!";document.write(txt.length);var txt="ABCDEFGHIJKLMNOPQRSTUVWXYZ";document.write(txt.length);  // 直接写入文档流（已过时，页面加载后调用会覆盖整页）
