// ============================================================
// 【第 43 节 · JavaScript String】demo4.js
// ============================================================
//
// 【知识点 / 后端类比】
...
//
var answer='It\'s alright';  // var 声明（函数作用域、会提升，推荐改用 let/const）
var answer="He is called \"Johnny\"";  // var 声明（函数作用域、会提升，推荐改用 let/const）
