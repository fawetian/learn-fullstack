...
//
var pi=3.14;  // var 声明（函数作用域、会提升，推荐改用 let/const）
// 如果你熟悉 ES6，pi 可以使用 const 关键字，表示一个常量
// const pi = 3.14;
var person="John Doe";  // var 声明（函数作用域、会提升，推荐改用 let/const）
var answer='Yes I am!';  // var 声明（函数作用域、会提升，推荐改用 let/const）
